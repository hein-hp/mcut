...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  selectMultipleInputFiles: (fileType) => ipcRenderer.invoke('select-multiple-input-files', fileType),
  ...
  batchConvertMkv: (params) => ipcRenderer.invoke('batch-convert-mkv', params),
